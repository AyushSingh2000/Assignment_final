...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:
          const HomePageWithPopUpCopyWidget(), // Set HomePageWidget as the home screen
    );
  }
}
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          highlightColor: Colors.transparent,
                                          onTap: () async {
                                            //   context.pushNamed('RooftoopSoiree');
                                          },
                                          child: Container(
                                            width: 200,
                                            height: 200,
                                                  ...
                                                  ClipRRect(
                                                    borderRadius:
                                                        BorderRadius.circular(
                                                            8),
                                                    child: Image.asset(
                                                      'assets/images/AISTHETIC-HERO_SHOWGIRL-WHITE.png',
                                                      width: double.infinity,
                                                      height: 356,
                                                      fit: BoxFit.cover,
                                                    ),
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          highlightColor: Colors.transparent,
                                          onTap: () async {
                                            //  context.pushNamed('TheGentleman');
                                          },
                                          child: Container(
                                            width: 200,
                                            height: 200,
                                                            ...
                                                            borderRadius:
                                                                BorderRadius
                                                                    .circular(
                                                                        8),
                                                            child: Image.asset(
                                                              'assets/images/Default_shot_from_a_worms_eye_view_fashion_photoshoot_of_a_han_0_(1).jpg',
                                                              width: double
                                                                  .infinity,
                                                              height: 240,
                                                              fit: BoxFit.cover,
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: Image.asset(
                                                'assets/images/AISTHETIC_CAROUSEL_(3).gif',
                                                //    'assets/images/Copy_of_AISTHETIC_CAROUSEL.gif',
                                                width: 400,
                                                height: 253,
                                                fit: BoxFit.cover,
                                              ),
